...
class Critic:
    ...
    def __init__(self, state_size, action_size, learning, dropout, reg=0.01):
...
#        net_states = layers.Dense(units=64, activation='relu')(net_states)
        ...
        net_actions = layers.Dense(units=32, activation='relu',
            kernel_regularizer=regularizers.l2(self.reg), activity_regularizer=regularizers.l1(self.reg))(actions)
...
#        net_actions = layers.Dropout(self.dropout_rate)(net_actions)  # Added dropout rate
#        net_actions = layers.BatchNormalization()(net_actions) # Added batch normalization
#        net_actions = layers.Dense(units=64, activation='relu')(net_actions)
        ...
        optimizer = optimizers.Adam(lr=self.learning_rate)  # Added learning rate
